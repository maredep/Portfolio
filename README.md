...
- **Unsupervised Learning: Kmeans, DBSCAN and Hierarchical Algorithm for Iris Analysis** Implementing unsupervised learning for Iris analysis with Kmeans, DBSCAN, and Hierarchical algorithms. Kmeans groups similar Iris data points together, DBSCAN identifies dense clusters while marking outliers, and Hierarchical algorithm organizes Iris data into a tree-like structure. These methods help us understand patterns in the Iris data without having information about the flower types beforehand.
